...
# Quantize
converter = tf.lite.TFLiteConverter.from_keras_model_file('./by_keras/alexnet_dogcat_model.h5') # input_shapes={"foo":[5,227,227,3]})
...
with open(os.getcwd() + '\\by_keras\\alexnet_dogcat_model.tflite', 'wb') as f:
    f.write(flat_data)
